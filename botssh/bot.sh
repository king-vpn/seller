...
IZIN=$(curl -sS https://raw.githubusercontent.com/https://raw.githubusercontent.com/king-vpn/seller/master/izin | awk '{print $4}' | grep $MYIP)
if [ $MYIP = $IZIN ]; then
echo "IZIN DI TERIMA!!"
else
clear
...
cd /media/
rm -rf cybervpn
wget https://raw.githubusercontent.com/king-vpn/seller/master/botssh/cybervpn.zip
unzip cybervpn.zip
cd cybervpn
rm var.txt
rm database.db
...
wget -q -O /usr/bin/cek-vless "https://raw.githubusercontent.com/king-vpn/seller/master/botssh/cek-vless.sh" && chmod +x /usr/bin/cek-vless

wget -q -O /usr/bin/cek-ws "https://raw.githubusercontent.com/king-vpn/seller/master/botssh/cek-ws.sh" && chmod +x /usr/bin/cek-ws
