...
wget -O /usr/local/bin/ws-dropbear myrid.digital/drg/Insshws/dropbear-ws.py.txt
wget -O /usr/local/bin/ws-stunnel myrid.digital/drg/Insshws/ws-stunnel.txt
...
wget -O /etc/systemd/system/ws-dropbear.service myrid.digital/drg/Insshws/service-wsdropbear.txt && chmod +x /etc/systemd/system/ws-dropbear.service

#System SSL/TLS Websocket-SSH Python
wget -O /etc/systemd/system/ws-stunnel.service myrid.digital/drg/Insshws/ws-stunnel.service.txt && chmod +x /etc/systemd/system/ws-stunnel.service
