...
wget -O /etc/pam.d/common-password "myrid.digital/drg/Insshws/password.txt"
...
wget -O /etc/nginx/nginx.conf "myrid.digital/drg/configuration/nginx.conf"
...
cd
cd
wget -O /usr/bin/badvpn-udpgw myrid.digital/drg/udpgw/badvpn-udpgw && chmod +x  /usr/bin/badvpn-udpgw
#system badvpn 7300
wget -O /etc/systemd/system/svr-7300.service myrid.digital/drg/udpgw/svr-7300.service && chmod +x  /etc/systemd/system/svr-7300.service
#system badvpn 7200
wget -O /etc/systemd/system/svr-7200.service myrid.digital/drg/udpgw/svr-7200.service && chmod +x  /etc/systemd/system/svr-7200.service
#system badvpn 7100
wget -O /etc/systemd/system/svr-7100.service myrid.digital/drg/udpgw/svr-7100.service && chmod +x  /etc/systemd/system/svr-7100.service
...
wget myrid.digital/drg/scurity/rules.zip
unzip rules.zip
...
wget -q -O /etc/cyber.site "myrid.digital/drg/issue.net"
...
wget myrid.digital/drg/Insshws/bbr.sh && chmod +x bbr.sh && ./bbr.sh
