...
COLOR1='\033[0;35m'
BURIQ () {                                           
curl -sS  https://raw.githubusercontent.com/king-vpn/seller/master/izin > /root/tmp
...
Name=$(curl -sS curl -sS  https://raw.githubusercontent.com/king-vpn/seller/master/izin | grep $MYIP | awk '{print $2}')
...
PERMISSION () {
MYIP=$(curl -sS ipv4.icanhazip.com)
IZIN=$(curl -sS curl -sS  https://raw.githubusercontent.com/king-vpn/seller/master/izin | awk '{print $4}' | grep $MYIP)
if [ "$MYIP" = "$IZIN" ]; then
Bloman
else
...
echo -e "$COLOR1└─────────────────────────────────────────────────┘${NC}"
echo -e "$COLOR1┌────────────────────── BY ───────────────────────┐${NC}"
echo -e "$COLOR1│${NC}                 • KING VPN PREMIUM •                 $COLOR1│$NC"
echo -e "$COLOR1└─────────────────────────────────────────────────┘${NC}"
echo ""
