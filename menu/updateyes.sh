...
wget -q -O /usr/bin/mbackup "https://raw.githubusercontent.com/king-vpn/seller/master/backup/backup.sh" && chmod +x /usr/bin/mbackup
...
wget -q -O /usr/bin/system "https://raw.githubusercontent.com/king-vpn/seller/master/menu/system.sh" && chmod +x /usr/bin/system
...
wget -q -O /usr/bin/upsc "https://raw.githubusercontent.com/king-vpn/seller/master/menu/upsc.sh" && chmod +x /usr/bin/upsc
wget -q -O /usr/bin/running "https://raw.githubusercontent.com/king-vpn/seller/master/menu/running.sh" && chmod +x /usr/bin/running
...
wget -q -O /usr/bin/menu-theme "https://raw.githubusercontent.com/king-vpn/seller/master/Themes/thema.sh" && chmod +x /usr/bin/menu-theme

wget -q -O /usr/bin/trial-generator "https://raw.githubusercontent.com/king-vpn/seller/master/trial/trial-generator.sh" && chmod +x /usr/bin/trial-generator
wget -q -O /usr/bin/add-udp "https://raw.githubusercontent.com/king-vpn/seller/master/menu/add-udp.sh" && chmod +x /usr/bin/add-udp
wget -q -O /usr/bin/mstrt "https://raw.githubusercontent.com/king-vpn/seller/master/backup/strt.sh" && chmod +x /usr/bin/mstrt
...
#wget -q -O /usr/bin/menu-bot "https://raw.githubusercontent.com/king-vpn/seller/master/menu/menu-bot.sh" && chmod +x /usr/bin/menu-bot
wget -q -O /usr/bin/genssl  "https://raw.githubusercontent.com/king-vpn/seller/master/genssl.sh" && chmod +x /usr/bin/genssl
#wget -q -O /usr/bin/addhost "https://raw.githubusercontent.com/king-vpn/seller/master/menu/addhost.sh" && chmod +x /usr/bin/addhost
echo -e "sleep 3 "
